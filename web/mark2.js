...
turnClass = class {
	constructor() {
		...
		var degreeOfCurve = 70 / 6;  // Complete turn = 6 segments
		...
		return [
			...
			// starting point
			[0,0,'black','black',90,10,20,20,0,pivotPoint,0,pivotPoint],

			// out of the fall line
			[3*arcLength, 3*degreeOfCurve,'black','gray',90,10,20,20,0,pivotPoint,0,pivotPoint],
			// bottom of the turn
			[3*arcLength, 3*degreeOfCurve,'red','gray',50,50,20,20,0,pivotPoint,0,pivotPoint],
			// traverse
			[3*arcLength, 10,'grey','black',40,60,20,20,0,pivotPoint,0,pivotPoint],

			// top of the turn
			[3*arcLength, -3*degreeOfCurve,'gray','black',10,90,20,20,0,pivotPoint,0,pivotPoint],
			[3*arcLength, -3*degreeOfCurve,'gray','black',10,90,20,20,0,pivotPoint,0,pivotPoint],
			// out of the fall line
			[3*arcLength, -3*degreeOfCurve,'grey','black',10,90,20,20,0,pivotPoint,0,pivotPoint],
			// bottom of the turn
			[3*arcLength, -3*degreeOfCurve,'grey','red',50,50,20,20,0,pivotPoint,0,pivotPoint],
			// traverse
			[3*arcLength, -10,'black','grey',60,40,20,20,0,pivotPoint,0,pivotPoint],
			// top of the turn
			[3*arcLength, 3*degreeOfCurve,'black','grey',90,10,20,20,0,pivotPoint,0,pivotPoint],
			[3*arcLength, 3*degreeOfCurve,'black','grey',90,10,20,20,0,pivotPoint,0,pivotPoint],
		];
	}
}
