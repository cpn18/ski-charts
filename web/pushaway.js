...
turnClass = class {
		...
		var start = [
			...
			[2*81,81,'black','black',60,40,20,20,0,55,0,55]
		];

		var left_footer = [
			// left-footer top
			[54, -27,'black','black',50,50,20,25,0,55,-20,55],

			// left-footer into the fall line (specify 90/10 at the fall line)
			[54, -27, 'black', 'black',20,80,20,25,0,55,-20,55],
			...
			// end of the turn
			[2*54, -54, 'black', 'black',40,60,20,20,0,55,0,55],
		];
