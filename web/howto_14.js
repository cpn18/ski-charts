...
turnClass = class {
	...
	getPath() {
		var start = [[0,45, "grey", "grey", 50, 50, 20, 20, 0, 55, 0, 55, 0]]
		var left_init = [100, -30, "grey", "red", 20, 80, 5, 35, -10, 55, -10, 55, -20]
		var right_init = flip(left_init)
		var left_shape = [100, -30, "grey", "blue", 10, 90, 5, 35, -10, 55, -10, 55, 20]
		var right_shape = flip(left_shape)
		var left_control = [100, -30, "grey", "green", 80, 20, 20, 20, -10, 55, -10, 55, 30]
